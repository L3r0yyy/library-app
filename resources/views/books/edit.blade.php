                ...
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('books.update', $book->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $book->title) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required autofocus>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="isbn" id="isbn" value="{{ old('isbn', $book->isbn) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="category_id" id="category_id" value="{{ old('category_id', $book->category_id) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                        </div>
